 ...
 * @author Cliente
 */
public class ComentarioEstabelecimentoDao {
    private Connection con;

    public boolean salvar(Comentario obj) throws SQLException, Exception {

        con = ConnectionFactory.getConnection();
        String sql = "INSERT INTO COMENTARIOESTABELECIMENTO(comentario,comentarista,datahora,idPublicacao)"
    ...
    public Comentario buscar(int idComentario) throws SQLException {
        ...
        String sql = "SELECT * FROM comentarioEstabelecimento WHERE idComentario= ? ";
    ...
    public List<Comentario> listar(int idPublicacao) throws SQLException {
        ...
        String sql = "SELECT idComentario from ComentarioEstabelecimento WHERE idPublicacao = ?";
        PreparedStatement stmt = con.prepareStatement(sql);
