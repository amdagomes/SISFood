        ...
        <section class="section">
            <div class="container ">
                <div class="columns is-2">
                    ...
                    <c:set var="myPublicacoes" scope="page" value="${dao.listar(sessionScope.usuario.id)}"/>
                    <c:choose>
                        <c:when test="${not empty myPublicacoes}">
                            <c:forEach var="publicacao" items="${myPublicacoes}">
